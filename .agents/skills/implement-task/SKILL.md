---
name: implement-task
description: Implement a task from docs/tasks-todo following documented architecture patterns. Use when asked to run /implement-task or to execute a specific task file.
---
...
4. Read `AGENTS.md` and relevant docs in `docs/developer/`.
5. Implement changes and add tests for business logic where required.
